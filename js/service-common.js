jQuery(function($) {
	...
	$('.banner-slider').on('swipe', function(event, slick, direction){
	  console.log(['direction', event, slick, direction]);
	  // left
	});

	// On edge hit
	$('.banner-slider').on('edge', function(event, slick, direction){
	  console.log(['edge was hit', event, slick, direction])
	});

	// On before slide change
	$('.banner-slider').on('beforeChange', function(event, slick, currentSlide, nextSlide){
	  console.log(['nextSlide', event, slick, currentSlide, nextSlide, slick.$slides]);
	});
