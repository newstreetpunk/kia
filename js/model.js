jQuery(function($) {
	...
	let modelParam = getModel('model'),
		model = modelParam;

	document.querySelector('h1').innerText = 'Купить KIA '+modelParam+' Comfort 1.6 MPI / 123 л.с.';
	document.querySelector('.model__header--img img').setAttribute('data-src', 'img/cars/'+modelParam.toUpperCase()+'-1.png');
